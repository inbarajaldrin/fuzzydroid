...
Copy this file into your CLI package at:
    fuzzydroid/<software>/utils/repl_skin.py

Usage:
    from fuzzydroid.<software>.utils.repl_skin import ReplSkin
...
_ACCENT_COLORS = {
    ...
    "fusion":      "\033[38;5;208m",   # Fusion 360 orange
}
...
class ReplSkin:
    ...
    def __init__(self, software: str, version: str = "1.0.0",
        ...
        #   fuzzydroid/<software>/utils/repl_skin.py  (this file)
        #   fuzzydroid/<software>/skills/SKILL.md     (target)
